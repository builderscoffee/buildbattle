...
public class TeamConfigurationPart {
    ...
    String targetAlreadyInTeam = "[Equipe] Le joueur %target% est déja dans l'équipe";
    String alreadyInTeam = "§cVous êtes déja dans une équipe";
    ...
    String alreadyCreated = "§7[§6Team§7]§c Vous avez déja crée une equipe";
    ...
    String disbandPlayers = "§7[§6Team§7]§c Votre groupe est suprimé";
}
