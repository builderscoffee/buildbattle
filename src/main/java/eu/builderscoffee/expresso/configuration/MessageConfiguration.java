...
public final class MessageConfiguration {
    ...
    String invitation_send = "§7[§6Team§7]§a Vous avez envoyé une invitation à §f%target%";
    String invitation_deny_target = "§7[§6Team§7] §aVous avez refusé l'invitation de §c%sender%";
    String invitation_deny_sender = "§7[§6Team§7]§f %target% §ca refusé votre invitation";
